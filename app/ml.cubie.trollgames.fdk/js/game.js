...
Coded By: @trollgamesz (Insta)
Hosted On: CubieCloud Apps
...
game.States.boot = function(){
	this.preload = function(){
		if(!game.device.desktop){
			...
			this.scale.refresh();
		} // Created by @trollgamesz (Insta) | Powered by CubieCloud Apps
...
game.States.preload = function(){
	this.preload = function(){
		...
		game.load.image('background','https://cloud.cubie.ml/app/ml.cubie.trollgames.fdk/assets/background.png'); 
    	game.load.image('ground','https://cloud.cubie.ml/app/ml.cubie.trollgames.fdk/assets/ground.png'); 
    	game.load.image('title','assets/title.png'); 
    	game.load.spritesheet('bird','https://cloud.cubie.ml/app/ml.cubie.trollgames.fdk/assets/bird.png',34,24,3); 
    	game.load.image('btn','assets/start-button.png');  
    	game.load.spritesheet('pipe','https://cloud.cubie.ml/app/ml.cubie.trollgames.fdk/assets/pipes.png',54,320,2); 
    	game.load.bitmapFont('flappy_font', 'https://cloud.cubie.ml/app/ml.cubie.trollgames.fdk/assets/fonts/flappyfont/flappyfont.png', 'https://cloud.cubie.ml/app/ml.cubie.trollgames.fdk/assets/fonts/flappyfont/flappyfont.fnt');
    	game.load.audio('fly_sound', 'https://cloud.cubie.ml/app/ml.cubie.trollgames.fdk/assets/flap.wav');
    	game.load.audio('score_sound', 'https://cloud.cubie.ml/app/ml.cubie.trollgames.fdk/assets/score.wav');
    	game.load.audio('hit_pipe_sound', 'https://cloud.cubie.ml/app/ml.cubie.trollgames.fdk/assets/pipe-hit.wav'); 
    	game.load.audio('hit_ground_sound', 'https://cloud.cubie.ml/app/ml.cubie.trollgames.fdk/assets/ouch.wav'); 
// Created by @trollgamesz (Insta) | Powered by CubieCloud Apps
    	game.load.image('ready_text','https://cloud.cubie.ml/app/ml.cubie.trollgames.fdk/assets/get-ready.png');
    	game.load.image('play_tip','https://cloud.cubie.ml/app/ml.cubie.trollgames.fdk/assets/instructions.png');
    	game.load.image('game_over','https://cloud.cubie.ml/app/ml.cubie.trollgames.fdk/assets/gameover.png');
    	game.load.image('score_board','https://cloud.cubie.ml/app/ml.cubie.trollgames.fdk/assets/scoreboard.png');
	}
	this.create = function(){
...
game.States.play = function(){
	this.create = function(){
		...
		this.soundHitPipe = game.add.sound('hit_pipe_sound'); // Created by @trollgamesz (Insta) | Powered by CubieCloud Apps
